...
public class SyncedInstance<T>
{
    ...
    public static byte[] SerializeToBytes(T val)
    {
        ...
        {
            PortableMultiToolBase.Instance.Logger.LogError($"Error serializing instance: {e}");
            return null;
        }
    }
    ...
    public static T DeserializeFromBytes(byte[] data)
    {
        ...
        {
            PortableMultiToolBase.Instance.Logger.LogError($"Error deserializing instance: {e}");
            return default;
        }
    }
}